...
<div class="container" style="margin-bottom:150px">
    <form  action="{{route('question.update', $question->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="" name="title" value="{{$question->title}}" required >
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <textarea name="description" id="description" class="form-control"  cols="30" rows="10">{{$question->description}}</textarea>
        </div>
